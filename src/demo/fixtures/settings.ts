...
export const APP_SETTINGS: AppSetting[] = [
  ...
  {
    key: "kpi.weight_punctuality", group: "operations",
    label: "Bobot penilaian — ketepatan waktu masuk",
    help: "Pemilik menyebut keterlambatan sebagai salah satu poin KPI. Ini besarnya. Untuk orang tanpa data absensi mesin, ukuran ini tidak dihitung sama sekali — bukan dianggap nol.",
    kind: "number", value: "25", default_value: "25",
    unit: "%", choices: null, reach: "forward",
    locked_reason: null, managed_at: null, affects: ["Penilaian kinerja"],
    updated_by: null, updated_at: null,
  ...
  {
    key: "kpi.weight_attendance", group: "operations",
    label: "Bobot penilaian — kehadiran",
    help: "Sakit bersurat dan cuti yang masih ada haknya tidak pernah dihitung sebagai absen: mengambil hak sendiri tidak boleh menurunkan nilai.",
    kind: "number", value: "25", default_value: "25",
    unit: "%", choices: null, reach: "forward",
    locked_reason: null, managed_at: null, affects: ["Penilaian kinerja"],
    updated_by: null, updated_at: null,
  ...
  {
    key: "kpi.min_measures", group: "operations",
    label: "Nilai gabungan baru muncul setelah sekian ukuran",
    help: "Di bawah ini, nilai gabungan tidak ditampilkan sama sekali. Nilai gabungan dari satu ukuran hanya ukuran itu sendiri dengan nama lain — dan ia terlihat seperti penilaian menyeluruh, yang justru berbahaya.",
    kind: "number", value: "2", default_value: "2",
    unit: "ukuran", choices: null, reach: "forward",
    locked_reason: null, managed_at: null, affects: ["Penilaian kinerja"],
    updated_by: null, updated_at: null,
  },
  {
