...
const RULES: Rule[] = [
  { tool: "hr.employee_files", any: ["ktp", "berkas 201", "kartu keluarga", "npwp", "bpjs", "nomor identitas", "berkas karyawan"], understood: "membaca berkas kepegawaian" },
  { tool: "hr.payroll", any: ["gaji", "slip gaji", "payroll", "upah", "thr", "lembur dibayar"], understood: "membaca data gaji" },
  ...
  { tool: "hr.attendance",
    any: ["absensi", "kehadiran", "jam masuk", "terlambat", "telat"],
    not: ["spk", "produksi", "order", "proyek", "kirim", "pengiriman", "bayar", "po ", "vendor"],
    understood: "membaca data kehadiran" },
  { tool: "it.audit", any: ["audit", "log aktivitas", "siapa membuka", "siapa mengubah", "hak akses", "peran", "pengguna sistem"], understood: "membaca modul IT" },
  { tool: "it.settings_write", any: ["ubah pengaturan", "ganti pengaturan", "setel ulang", "ubah zona waktu", "ubah toleransi"], understood: "mengubah pengaturan" },
  ...
  /* Writing. Checked before the read rules so "buatkan PO" is not read as
     "berapa PO". */
  { tool: "procurement.draft_po", any: ["buatkan po", "buat po", "bikin po", "po baru", "order ke vendor"], understood: "menyiapkan purchase order baru" },
  { tool: "procurement.draft_pr_line", any: ["minta beli", "permintaan pembelian", "request beli", "ajukan pembelian", "pr baru"], understood: "menyiapkan baris permintaan pembelian" },

  /* Reading. */
  { tool: "procurement.pending_approvals", any: ["menunggu persetujuan", "belum disetujui", "perlu approve", "antrian approval", "rapat", "belum di-approve"], understood: "melihat baris yang menunggu persetujuan" },
  { tool: "procurement.vendor_debt", any: ["hutang", "utang", "belum dibayar", "tagihan vendor", "sisa bayar"], understood: "melihat kewajiban ke vendor" },
  { tool: "accounting.balances", any: ["saldo", "kas", "rekening", "uang kita", "duit"], understood: "melihat saldo rekening" },
  { tool: "inventory.low_stock", any: ["menipis", "stok minimum", "hampir habis", "stok kurang", "restock", "di bawah minimum"], understood: "melihat barang di bawah minimum" },
  { tool: "production.late_orders",
    all: ["spk"], any: ["telat", "terlambat", "molor", "lewat"],
    understood: "melihat SPK yang lewat tanggal" },
  { tool: "production.late_orders",
    all: ["produksi"], any: ["telat", "terlambat", "molor", "lewat"],
    understood: "melihat SPK yang lewat tanggal" },
  { tool: "delivery.fulfilment", any: ["sudah dikirim", "sampai mana", "progres proyek", "terpasang", "serah terima"], understood: "melihat sejauh mana pesanan klien sampai" },
];
...
const GUIDES: { tool: string; any: string[]; understood: string }[] = [
  ...
  { tool: "guide.receive_goods", any: ["barang datang", "terima barang", "penerimaan", "surat jalan"], understood: "menjelaskan cara mencatat barang datang" },
  { tool: "guide.pay_line", any: ["bayar", "pembayaran", "melunasi"], understood: "menjelaskan cara membayar baris permintaan" },
];

const HOW = ["cara", "bagaimana", "gimana", "sop", "langkah", "caranya"];
